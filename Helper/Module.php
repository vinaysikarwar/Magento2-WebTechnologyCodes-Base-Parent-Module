...
class Module extends AbstractHelper
{
    ...
    const URL_EXTENSIONS  = 'http://WebTechnologyCodes.com/feed-extensions-m2.xml';

    /**
     * @var \WebTechnologyCodes\Base\Model\Serializer
     */
     ...
     * @param \WebTechnologyCodes\Base\Model\Serializer $serializer
     * @param \Magento\Framework\App\CacheInterface $cache
     * @param CurlClient $curl
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \WebTechnologyCodes\Base\Model\Serializer $serializer,
    ...
    /**
     * Get array with info about all WebTechnologyCodes Magento2 Extensions
     * @return bool|mixed
     */
